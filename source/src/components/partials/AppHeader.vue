    ...
    <b-navbar class="fixed-top" toggleable="md" type="dark" variant="info">
        ...
        <b-collapse is-nav id="nav_collapse">
            <b-navbar-nav class="header-links">
                <b-nav-item href="#"
                    ><i class="mdi mdi-image-filter"></i>Gallery</b-nav-item
                >
                <b-nav-item href="#" active
                    ><i class="mdi mdi-email-outline"></i>Inbox</b-nav-item
                >
                <b-nav-item href="#"
                    ><i class="mdi mdi-calendar"></i>Calendar</b-nav-item
                >
            </b-navbar-nav>
                    ...
                    <b-dropdown-item class="preview-item" href="#">
                        <div class="preview-thumbnail">
                            <div class="preview-icon bg-success">
                                <i
                                    class="mdi mdi-alert-circle-outline mx-0"
                                ></i>
                            </div>
                        </div>
                    ...
                    <b-dropdown-item class="preview-item" href="#">
                        <div class="preview-thumbnail">
                            <div class="preview-icon bg-warning">
                                <i
                                    class="mdi mdi-comment-text-outline mx-0"
                                ></i>
                            </div>
                        </div>
                        <div class="preview-item-content">
